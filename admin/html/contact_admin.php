    ...
    <div class="col-lg-12 mb-4 order-0">
      <div class="card">
        <div class="d-flex align-items-end row">
          <div class="col-sm-7">
          <div class="card-body">
                          <h5 class="card-title text-danger">Enquiry</h5>
                          <!-- <p class="mb-4">
                            ...
                            <div class="table-responsive text-nowrap">
                                <table class="table table-striped">
                                    ...
                                    <tbody class="table-border-bottom-0">
                                        <?php foreach ($records as $contacts) { ?>
                                            <tr>
                                                <td><i class="fab fa-angular fa-lg text-danger me-3"></i><strong><?php echo $contacts['SR_NO'] ?></strong></td>
                                                <td><?php echo $contacts['NAME'] ?></td>
                                                <td><?php echo $contacts['MOBILE_NO'] ?></td>
